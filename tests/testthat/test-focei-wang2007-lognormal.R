nmTest({
  ...
  test_that("lognormal likelihood can be determined by data too", {
    ...
    suppressWarnings({
      ...
      c(-42.106, -42.106, -42.106, -42.106, -42.09, -42.09, -42.091,
        -42.091, -42.106, -42.106),
