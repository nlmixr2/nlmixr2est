...
test_that("the other parameterizations carry exactly (eta+covariate on each slot kind)", {
  ...
  cases <- list(
    ...
    list(
      # nolint: indentation_linter.
      name = "2-cmt A/B/alpha/beta (B in Vc)",
      mod = function() {
        # nolint: indentation_linter.
    ...
    list(
      # nolint: indentation_linter.
      name = "2-cmt v/B/alpha/beta (v in Vc)",
      mod = function() {
        # nolint: indentation_linter.
        ini({ # nolint: indentation_linter.
          ta <- log(0.5)
    ...
    list(
      # nolint: indentation_linter.
      name = "3-cmt v/B/C/alpha/beta/gamma (C in Vc)",
      mod = function() {
        # nolint: indentation_linter.
        ini({ # nolint: indentation_linter.
          ta <- log(1)
