nmTest({
  ...
  .propVals <- c(39.458, 39.458, 39.207, 39.207, 39.213, 39.213,
                 39.297, 39.297, 39.458, 39.458)
  .propModVals <- c(63.353, 63.353, 63.001, 63.063, 63.063, 63.063,
                    62.792, 62.792, 63.353, 63.353)
  .propFVals <- c(6.496, 6.496, 6.275, 6.275, 9.262, 9.262, 6.599,
                  6.599, 6.496, 6.496)
  .propFModVals <- c(19.177, 19.177, 18.202, 18.202, 18.333, 18.333,
                     19.195, 19.195, 19.177, 19.177)
  .addVals <- c(-2.059, -2.059, -2.059, -2.059, 0.026, 0.026, -1.938,
                -1.938, -2.059, -2.059)
  .addModVals <- c(3.238, 3.238, 2.438, 2.438, 3.311, 3.311, 3.378,
                   3.378, 3.238, 3.238)
  .powVals <- c(9.966, 9.966, 9.331, 9.331, 9.651, 9.651, 10.069,
                10.069, 9.966, 9.966)
  .powF1Vals <- c(27.301, 27.301, 26.854, 26.854, 26.888, 26.888,
                  27.254, 27.254, 27.301, 27.301)
  .powF2Vals <- c(17.831, 17.831, 16.617, 16.617, 16.852, 16.852,
                  17.959, 17.959, 17.831, 17.831)
  .powF3Vals <- c(79.733, 79.733, 79.371, 79.448, 79.448, 79.448,
                  79.055, 79.055, 79.733, 79.733)
  .powFModVals <- c(0.776, 0.776, 0.58, 0.58, 3.2, 3.2, 0.883,
                    0.883, 0.776, 0.776)
  .powFMod1Vals <- c(24.877, 24.877, 24.518, 24.518, 24.554, 24.554,
                     24.839, 24.839, 24.877, 24.877)
  .powFMod2Vals <- c(49.312, 49.312, 49.311, 49.296, 52.603, 52.603,
                     49.367, 49.367, 49.312, 49.312)
  .powFMod3Vals <- c(10.848, 10.848, 9.446, 9.446, 9.96, 9.96,
                     11.024, 11.024, 10.848, 10.848)
  .boxCoxPropTVals <- c(35.132, 35.132, 34.879, 34.694, 34.709,
                        34.709, 34.983, 34.983, 35.132, 35.132)
  .boxCoxPropTModVals <- c(58.21, 58.21, 57.741, 57.802, 57.803,
                           57.803, 57.59, 57.59, 58.21, 58.21)
  .boxCoxPropTVals <- c(35.132, 35.132, 34.879, 34.694, 34.709,
                        34.709, 34.983, 34.983, 35.132, 35.132)
  .boxCoxPowTVals <- c(9.11, 9.11, 8.215, 8.215, 8.644, 8.644,
                       9.224, 9.224, 9.11, 9.11)
  .boxCoxPowTF1Vals <- c(25.57, 25.57, 24.951, 24.951, 25.002,
                         25.002, 25.538, 25.538, 25.57, 25.57)
  .boxCoxPowTF2Vals <- c(16.507, 16.507, 14.981, 14.981, 15.314,
                         15.314, 16.682, 16.682, 16.507, 16.507)
  .boxCoxPowTF3Vals <- c(76.496, 76.496, 76.097, 76.179, 76.179,
                         76.179, 75.791, 75.791, 76.496, 76.496)
  .boxCoxAddModPropTMod2 <- c(100.737, 100.737, 100.351, 100.437,
                              100.437, 100.437, 99.851, 99.851, 100.737, 100.737)
  .boxCoxAddPropT2Vals <- c(35.457, 35.457, 35.224, 35.056, 35.07,
                            35.07, 35.315, 35.315, 35.195, 35.195)
  ...
  }, c(35.132, 35.132, 34.879, 34.694, 34.709, 34.709, 34.983, 34.983,
       35.132, 35.132),
  addProp = 2)
  ...
  .boxCoxAddPropTc2Vals <- c(35.457, 35.457, 35.224, 35.056, 35.07,
                             35.07, 35.315, 35.315, 35.457, 35.457)
  ...
  }, c(10.886, 10.886, 10.417, 10.417, 10.662, 10.662, 10.978, 10.978,
  ...
  .addPow1 <- c(16.231, 16.231, 16.008, 16.008, 16.093, 16.093, 16.278, 16.278,
                16.231, 16.231)
