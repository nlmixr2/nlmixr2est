...
This creates two reports with default settings, both a [pdf](https://github.com/nlmixr2/nlmixr2/raw/master/vignettes/nlmixr_report.pdf) and [word](https://github.com/nlmixr2/nlmixr2/raw/master/vignettes/nlmixr_report.docx) document. The report can be customized by editing the default template to include project specificities (change labels, stratifications, filtering, etc.).
...
table](https://nlmixr2.github.io/RxODE/articles/RxODE-event-table.html)
created from RxODE.
...
windows](https://nlmixr2.github.io/RxODE/articles/RxODE-event-table.html#add-doses-and-samples-within-a-sampling-window)
