...
#> → compress parHistData in nlmixr2 object, save 2672

print(fit2)
#> ── nlmixr² log-likelihood nlminb ──
#> 
#>           OBJF      AIC      BIC Log-likelihood Condition#(Cov) Condition#(Cor)
#> lPop -637.4326 1206.445 1221.168      -600.2223        717.1534         71.8244
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.002827 0.033    0.012 1.258173
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.     SE  %RSE    Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.5401 0.2165  40.1 -0.5401 (-0.9645, -0.1156)                    
#> Em    5.524   3.12 56.48     5.524 (-0.5909, 11.64)                    
#> E50     3.6  1.843  51.2       3.6 (-0.0127, 7.212)                    
#> g         2  FIXED FIXED                          2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0376     1 -0.999 -0.539
#> 2 1     0.0568     0 -0.460 -0.539
#> 3 1     0.0638     1 -0.998 -0.538
#> # ℹ 997 more rows
...
#> 
#> $scaleC
#> [1] 0.002751528 0.029833237 0.029063705
#> 
#> $parHistData
#>    iter                type     objf            E0            Em           E50
#> 1     1              Scaled 688.8257 -1.000000e+00 -1.000000e+00  1.000000e+00
#> 2     1            Unscaled 688.8257  5.000000e-01  5.000000e-01  2.000000e+00
#> 3     1    Back-Transformed 688.8257  5.000000e-01  5.000000e-01  2.000000e+00
#> 4     2              Scaled 688.3273 -1.547526e+00 -2.480189e-01  1.174252e+00
#> 5     2            Unscaled 688.3273  4.984935e-01  5.224340e-01  2.005064e+00
#> 6     2    Back-Transformed 688.3273  4.984935e-01  5.224340e-01  2.005064e+00
#> 7     3              Scaled 686.8725 -3.400744e+00  1.849660e+00  1.862517e+00
#> 8     3            Unscaled 686.8725  4.933943e-01  5.850146e-01  2.025068e+00
#> 9     3    Back-Transformed 686.8725  4.933943e-01  5.850146e-01  2.025068e+00
#> 10    4              Scaled 681.5720 -1.227626e+01  8.119515e+00  5.892805e+00
#> 11    4            Unscaled 681.5720  4.689731e-01  7.720647e-01  2.142203e+00
#> 12    4    Back-Transformed 681.5720  4.689731e-01  7.720647e-01  2.142203e+00
#> 13    5              Scaled 663.2305 -5.181880e+01  2.412676e+01  2.419048e+01
#> 14    5            Unscaled 663.2305  3.601706e-01  1.249613e+00  2.674001e+00
#> 15    5    Back-Transformed 663.2305  3.601706e-01  1.249613e+00  2.674001e+00
#> 16    6              Scaled 624.5650 -2.290591e+02  7.807625e+01  8.996829e+01
#> 17    6            Unscaled 624.5650 -1.275110e-01  2.859101e+00  4.585748e+00
#> 18    6    Back-Transformed 624.5650 -1.275110e-01  2.859101e+00  4.585748e+00
#> 19    7              Scaled 656.7159 -3.690630e+02  1.258602e+02 -1.225990e+02
#> 20    7            Unscaled 656.7159 -5.127357e-01  4.284649e+00 -1.592244e+00
#> 21    7    Back-Transformed 656.7159 -5.127357e-01  4.284649e+00 -1.592244e+00
#> 22    8              Scaled 622.8073 -2.715511e+02  1.175352e+02  1.404415e+01
#> 23    8            Unscaled 622.8073 -2.444290e-01  4.036289e+00  2.379111e+00
#> 24    8    Back-Transformed 622.8073 -2.444290e-01  4.036289e+00  2.379111e+00
#> 25    9              Scaled 605.1996 -3.170450e+02  1.025121e+02  2.263979e+01
#> 26    9            Unscaled 605.1996 -3.696065e-01  3.588102e+00  2.628933e+00
#> 27    9    Back-Transformed 605.1996 -3.696065e-01  3.588102e+00  2.628933e+00
#> 28   10              Scaled 601.0979 -3.558781e+02  1.285683e+02  3.889729e+01
#> 29   10            Unscaled 601.0979 -4.764569e-01  4.365441e+00  3.101436e+00
#> 30   10    Back-Transformed 601.0979 -4.764569e-01  4.365441e+00  3.101436e+00
#> 31   11              Scaled 600.2717 -3.843164e+02  1.528642e+02  4.798692e+01
#> 32   11            Unscaled 600.2717 -5.547057e-01  5.090266e+00  3.365614e+00
#> 33   11    Back-Transformed 600.2717 -5.547057e-01  5.090266e+00  3.365614e+00
#> 34   12              Scaled 600.2245 -3.797091e+02  1.641116e+02  5.432697e+01
#> 35   12            Unscaled 600.2245 -5.420286e-01  5.425813e+00  3.549879e+00
#> 36   12    Back-Transformed 600.2245 -5.420286e-01  5.425813e+00  3.549879e+00
#> 37   13              Scaled 600.2223 -3.790512e+02  1.671905e+02  5.592953e+01
#> 38   13            Unscaled 600.2223 -5.402183e-01  5.517668e+00  3.596456e+00
#> 39   13    Back-Transformed 600.2223 -5.402183e-01  5.517668e+00  3.596456e+00
#> 40   14              Scaled 600.2223 -3.789969e+02  1.674050e+02  5.604320e+01
#> 41   14            Unscaled 600.2223 -5.400690e-01  5.524068e+00  3.599759e+00
#> 42   14    Back-Transformed 600.2223 -5.400690e-01  5.524068e+00  3.599759e+00
#> 43   15              Scaled 600.2223 -3.789958e+02  1.674077e+02  5.604482e+01
#> 44   15            Unscaled 600.2223 -5.400661e-01  5.524146e+00  3.599806e+00
#> 45   15    Back-Transformed 600.2223 -5.400661e-01  5.524146e+00  3.599806e+00
#> 46   16              Scaled 600.2223 -3.789958e+02  1.674077e+02  5.604482e+01
#> 47   16            Unscaled 600.2223 -5.400661e-01  5.524146e+00  3.599806e+00
#> 48   16    Back-Transformed 600.2223 -5.400661e-01  5.524146e+00  3.599806e+00
#> 49    1 Forward Sensitivity       NA  2.984541e-01 -4.322108e-01 -8.996807e-02
#> 50    6 Forward Sensitivity       NA  3.962978e-03 -3.903414e-01  2.537080e-01
#> 51    8 Forward Sensitivity       NA  2.540147e-01  5.100176e-01 -1.102089e+00
#> 52    9 Forward Sensitivity       NA  9.829978e-02  5.015860e-02 -2.224233e-01
#> 53   10 Forward Sensitivity       NA  2.916642e-02 -2.232011e-02 -2.206683e-02
#> 54   11 Forward Sensitivity       NA -3.249141e-03 -1.270619e-02  1.164714e-02
#> 55   12 Forward Sensitivity       NA -2.931311e-04 -2.377635e-03  2.071138e-03
#> 56   13 Forward Sensitivity       NA -2.289096e-05 -1.425456e-04  1.217352e-04
#> 57   14 Forward Sensitivity       NA -7.071978e-08 -4.872339e-07 -8.214017e-07
#> 58   15 Forward Sensitivity       NA  4.516929e-10  2.411824e-09 -2.164365e-08
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -378.99583  167.40768   56.04482 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001589130  0.001727760 -0.003819311
#> Em   0.001727760  0.004883265 -0.008796312
#> E50 -0.003819311 -0.008796312  0.017350816
#> 
#> $covMethod
#> [1] "r (nlminb)"
#> 
#> $cov.scaled
#>           E0        Em      E50
#> E0  6193.588  3047.138 2908.152
#> Em  3047.138 10937.230 6215.572
#> E50 2908.152  6215.572 4021.785
#> 
#> $cov
#>             E0        Em       E50
#> E0  0.04689107 0.2501303 0.2325638
#> Em  0.25013034 9.7343752 5.3893014
#> E50 0.23256376 5.3893014 3.3971975
#> 
#> $r
#>               E0           Em          E50
#> E0   0.000794565  0.000863880 -0.001909656
#> Em   0.000863880  0.002441632 -0.004398156
#> E50 -0.001909656 -0.004398156  0.008675408
#> 
# }
```
