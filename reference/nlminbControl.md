...
#> ✔ done
#> → compress origData in nlmixr2 object, save 8336
#> → compress parHistData in nlmixr2 object, save 2800

print(fit2)
#> ── nlmixr² log-likelihood nlminb ──
#> 
#>           OBJF      AIC      BIC Log-likelihood Condition#(Cov) Condition#(Cor)
#> lPop -658.7064 1185.171 1199.894      -589.5853        2943.079        113.3684
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.002952 0.032    0.011 0.957048
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.     SE  %RSE    Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.4614 0.1955 42.37 -0.4614 (-0.8446, -0.0782)                    
#> Em    8.587  6.935 80.77      8.587 (-5.006, 22.18)                    
#> E50   4.697  2.679 57.04     4.697 (-0.5539, 9.948)                    
#> g         2  FIXED FIXED                          2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0261     0 -0.489 -0.461
#> 2 1     0.0476     1 -0.950 -0.461
#> 3 1     0.0505     0 -0.489 -0.460
#> # ℹ 997 more rows
...
#> 
#> $scaleC
#> [1] 0.002895922 0.034035845 0.031273778
#> 
#> $parHistData
#>    iter                type     objf            E0            Em           E50
#> 1     1              Scaled 677.3575 -1.000000e+00 -1.000000e+00  1.000000e+00
#> 2     1            Unscaled 677.3575  5.000000e-01  5.000000e-01  2.000000e+00
#> 3     1    Back-Transformed 677.3575  5.000000e-01  5.000000e-01  2.000000e+00
#> 4     2              Scaled 676.7007 -1.356555e+00 -1.486384e-01  1.111798e+00
#> 5     2            Unscaled 676.7007  4.989674e-01  5.289768e-01  2.003496e+00
#> 6     2    Back-Transformed 676.7007  4.989674e-01  5.289768e-01  2.003496e+00
#> 7     3              Scaled 674.8328 -2.666810e+00  2.308910e+00  1.628328e+00
#> 8     3            Unscaled 674.8328  4.951730e-01  6.126216e-01  2.019650e+00
#> 9     3    Back-Transformed 674.8328  4.951730e-01  6.126216e-01  2.019650e+00
#> 10    4              Scaled 668.5453 -1.046939e+01  9.810505e+00  5.586290e+00
#> 11    4            Unscaled 668.5453  4.725774e-01  8.679447e-01  2.143431e+00
#> 12    4    Back-Transformed 668.5453  4.725774e-01  8.679447e-01  2.143431e+00
#> 13    5              Scaled 649.1847 -5.099130e+01  2.582848e+01  2.353783e+01
#> 14    5            Unscaled 649.1847  3.552291e-01  1.413130e+00  2.704843e+00
#> 15    5    Back-Transformed 649.1847  3.552291e-01  1.413130e+00  2.704843e+00
#> 16    6              Scaled 616.1000 -2.058084e+02  6.353692e+01  6.266781e+01
#> 17    6            Unscaled 616.1000 -9.310897e-02  2.696569e+00  3.928585e+00
#> 18    6    Back-Transformed 616.1000 -9.310897e-02  2.696569e+00  3.928585e+00
#> 19    7              Scaled 735.0190 -3.581761e+02  1.054654e+02 -9.565423e+01
#> 20    7            Unscaled 735.0190 -5.343541e-01  4.123641e+00 -1.022743e+00
#> 21    7    Back-Transformed 735.0190 -5.343541e-01  4.123641e+00 -1.022743e+00
#> 22    8              Scaled 601.9944 -2.211976e+02  9.056868e+01  3.358728e+01
#> 23    8            Unscaled 601.9944 -1.376751e-01  3.616617e+00  3.019128e+00
#> 24    8    Back-Transformed 601.9944 -1.376751e-01  3.616617e+00  3.019128e+00
#> 25    9              Scaled 595.8750 -2.564918e+02  1.128068e+02  4.512758e+01
#> 26    9            Unscaled 595.8750 -2.398841e-01  4.373510e+00  3.380036e+00
#> 27    9    Back-Transformed 595.8750 -2.398841e-01  4.373510e+00  3.380036e+00
#> 28   10              Scaled 590.8069 -3.342710e+02  1.445281e+02  5.141810e+01
#> 29   10            Unscaled 590.8069 -4.651268e-01  5.453171e+00  3.576764e+00
#> 30   10    Back-Transformed 590.8069 -4.651268e-01  5.453171e+00  3.576764e+00
#> 31   11              Scaled 589.9254 -3.410954e+02  1.739608e+02  6.058919e+01
#> 32   11            Unscaled 589.9254 -4.848895e-01  6.454940e+00  3.863579e+00
#> 33   11    Back-Transformed 589.9254 -4.848895e-01  6.454940e+00  3.863579e+00
#> 34   12              Scaled 589.6554 -3.360850e+02  2.041022e+02  7.424336e+01
#> 35   12            Unscaled 589.6554 -4.703797e-01  7.480826e+00  4.290596e+00
#> 36   12    Back-Transformed 589.6554 -4.703797e-01  7.480826e+00  4.290596e+00
#> 37   13              Scaled 589.5924 -3.339502e+02  2.254450e+02  8.294931e+01
#> 38   13            Unscaled 589.5924 -4.641976e-01  8.207247e+00  4.562865e+00
#> 39   13    Back-Transformed 589.5924 -4.641976e-01  8.207247e+00  4.562865e+00
#> 40   14              Scaled 589.5855 -3.331249e+02  2.348876e+02  8.659452e+01
#> 41   14            Unscaled 589.5855 -4.618078e-01  8.528635e+00  4.676864e+00
#> 42   14    Back-Transformed 589.5855 -4.618078e-01  8.528635e+00  4.676864e+00
#> 43   15              Scaled 589.5853 -3.329882e+02  2.365325e+02  8.721514e+01
#> 44   15            Unscaled 589.5853 -4.614118e-01  8.584618e+00  4.696273e+00
#> 45   15    Back-Transformed 589.5853 -4.614118e-01  8.584618e+00  4.696273e+00
#> 46   16              Scaled 589.5853 -3.329822e+02  2.365919e+02  8.723834e+01
#> 47   16            Unscaled 589.5853 -4.613943e-01  8.586641e+00  4.696999e+00
#> 48   16    Back-Transformed 589.5853 -4.613943e-01  8.586641e+00  4.696999e+00
#> 49   17              Scaled 589.5853 -3.329821e+02  2.365926e+02  8.723865e+01
#> 50   17            Unscaled 589.5853 -4.613940e-01  8.586665e+00  4.697008e+00
#> 51   17    Back-Transformed 589.5853 -4.613940e-01  8.586665e+00  4.697008e+00
#> 52   18              Scaled 589.5853 -3.329821e+02  2.365926e+02  8.723865e+01
#> 53   18            Unscaled 589.5853 -4.613940e-01  8.586665e+00  4.697008e+00
#> 54   18    Back-Transformed 589.5853 -4.613940e-01  8.586665e+00  4.697008e+00
#> 55    1 Forward Sensitivity       NA  2.616394e-01 -6.654994e-01 -7.538535e-02
#> 56    6 Forward Sensitivity       NA  2.443167e-03 -5.200849e-01  3.141049e-01
#> 57    8 Forward Sensitivity       NA  1.380643e-01 -4.803583e-02 -1.323040e-01
#> 58   10 Forward Sensitivity       NA -9.491358e-03 -7.868066e-02  8.810574e-02
#> 59   11 Forward Sensitivity       NA -4.487099e-03 -2.205376e-02  1.821818e-02
#> 60   12 Forward Sensitivity       NA -1.883785e-03 -9.088635e-03  1.047962e-02
#> 61   13 Forward Sensitivity       NA -7.341984e-04 -2.826736e-03  4.019361e-03
#> 62   14 Forward Sensitivity       NA -1.226289e-04 -4.233236e-04  6.569897e-04
#> 63   15 Forward Sensitivity       NA -3.453039e-06 -1.131514e-05  1.441872e-05
#> 64   16 Forward Sensitivity       NA -4.646287e-10  4.991195e-09 -1.824892e-07
#> 65   17 Forward Sensitivity       NA  5.312978e-11  2.596048e-10 -2.838251e-09
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -332.98205  236.59260   87.23865 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001733752  0.001203659 -0.003386052
#> Em   0.001203659  0.002300787 -0.005719193
#> E50 -0.003386052 -0.005719193  0.014902217
#> 
#> $covMethod
#> [1] "r (nlminb)"
#> 
#> $cov.scaled
#>           E0        Em       E50
#> E0  4557.836  4126.324  2619.228
#> Em  4126.324 41518.858 16871.737
#> E50 2619.228 16871.737  7338.610
#> 
#> $cov
#>             E0         Em        E50
#> E0  0.03822366  0.4067117  0.2372141
#> Em  0.40671165 48.0970553 17.9587745
#> E50 0.23721409 17.9587745  7.1775215
#> 
#> $r
#>                E0            Em          E50
#> E0   0.0008668758  0.0006018296 -0.001693026
#> Em   0.0006018296  0.0011503933 -0.002859596
#> E50 -0.0016930260 -0.0028595963  0.007451109
#> 
# }
```
