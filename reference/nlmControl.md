...
#> elapsed 0.08195946 0.1469317  5.829e-06      0.029       0.003 0.017    0.001
#>              other
#> elapsed 0.05610302
#> 
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0358     0 -0.430 -0.623
#> 2 1     0.0521     0 -0.430 -0.622
#> 3 1     0.0610     0 -0.430 -0.622
#> # ℹ 997 more rows
...
#> $estimate
#>         E0         Em        E50 
#> -0.6231504  8.3074150  4.3859336 
#> 
#> $gradient
#> [1]  0.22030620 -0.01564801 -0.05843588
#> 
#> $hessian
#>            E0        Em        E50
#> E0  801.08578 52.525353 -40.233867
#> Em   52.52535  9.130508  -6.402953
#> E50 -40.23387 -6.402953   3.629248
#> 
#> $code
#> [1] 1
#> 
