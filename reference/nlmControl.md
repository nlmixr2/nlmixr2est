...
#> lPop -701.6009 1142.276 1156.999      -568.1381         1235007        200859.7
#> 
#> ── Time (sec $time): ──
#> 
#>             setup  optimize covariance preprocess postprocess table compress
#> elapsed 0.3277271 0.5550045  6.552e-06      0.047       0.019 0.026    0.001
#>             other
#> elapsed 0.1042619
#> 
...
#> E0  -0.6135 7.374  1202 -0.6135 (-15.07, 13.84)                    
#> Em    6.038 132.8  2198   6.038 (-254.2, 266.2)                    
#> E50   2.988 65.99  2208   2.988 (-126.3, 132.3)                    
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0489     0 -0.433 -0.612
#> 2 1     0.0679     0 -0.434 -0.610
#> 3 1     0.0702     0 -0.434 -0.610
#> # ℹ 997 more rows
...
#> $estimate
#>         E0         Em        E50 
#> -0.6135168  6.0384986  2.9879323 
#> 
#> $gradient
#> [1] -4.528911e-08 -3.885254e-07  2.938406e-07
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001802122  0.002741727 -0.007335731
#> Em   0.002741727  0.009256021 -0.021562644
#> E50 -0.007335731 -0.021562644  0.047774304
#> 
#> $code
#> [1] 1
#> 
...
#> 
#> $scaleC
#> [1] 0.003023615 0.040886709 0.036408436
#> 
#> $estimate.scaled
#>         E0         Em        E50 
#> -369.27334  134.45963   28.13471 
#> 
#> $cov.scaled
#>          E0       Em     E50
#> E0  5948222  7914875 4418898
#> Em  7914875 10541996 5884464
#> E50 4418898  5884464 3284879
#> 
#> $r
#>                E0           Em          E50
#> E0   0.0009010609  0.001370864 -0.003667866
#> Em   0.0013708636  0.004628010 -0.010781322
#> E50 -0.0036678657 -0.010781322  0.023887152
#> 
