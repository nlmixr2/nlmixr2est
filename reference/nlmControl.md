...
#> lPop -684.133 1159.744 1174.467       -576.872        952440.6        217221.1
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.002903 0.034    0.001 0.892097
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.    SE  %RSE Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.7291 7.757  1064 -0.7291 (-15.93, 14.47)                    
#> Em    5.179 110.8  2140     5.179 (-212, 222.4)                    
#> E50   2.646 60.94  2303   2.646 (-116.8, 122.1)                    
#> g         2 FIXED FIXED                       2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0480     0 -0.394 -0.727
#> 2 1     0.0519     1 -1.12  -0.727
#> 3 1     0.0541     0 -0.394 -0.727
#> # ℹ 997 more rows
...
#> $estimate
#>         E0         Em        E50 
#> -0.7291413  5.1786864  2.6460983 
#> 
#> $gradient
#> [1]  5.732861e-09  4.411365e-08 -5.502036e-07
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001613897  0.002930968 -0.007321887
#> Em   0.002930968  0.011167259 -0.023808285
#> E50 -0.007321887 -0.023808285  0.050534266
#> 
#> $code
#> [1] 1
#> 
...
#> 
#> $scaleC
#> [1] 0.002845152 0.035639559 0.033026873
#> 
#> $estimate.scaled
#>        E0        Em       E50 
#> -433.0125  130.2779   20.5628 
#> 
#> $covMethod
#> [1] "r (nlm)"
#> 
#> $cov.scaled
#>          E0      Em     E50
#> E0  7432564 8472247 5029205
#> Em  8472247 9666633 5737035
#> E50 5029205 5737035 3405090
#> 
#> $cov
#>            E0         Em       E50
#> E0   60.16579   859.0856  472.5767
#> Em  859.08556 12278.3464 6752.8527
#> E50 472.57670  6752.8527 3714.1845
#> 
#> $r
#>                E0           Em          E50
#> E0   0.0008069484  0.001465484 -0.003660943
#> Em   0.0014654838  0.005583630 -0.011904143
#> E50 -0.0036609434 -0.011904143  0.025267133
#> 
