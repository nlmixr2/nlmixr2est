...
#> elapsed 0.003195 0.041    0.001 1.033805
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.    SE  %RSE Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.5923  5.69 960.7 -0.5923 (-11.74, 10.56)                    
#> Em    6.204   145  2337   6.204 (-277.9, 290.4)                    
#> E50   3.299 70.45  2136   3.299 (-134.8, 141.4)                    
#> g         2 FIXED FIXED                       2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0480     0 -0.441 -0.591
#> 2 1     0.0519     0 -0.441 -0.591
#> 3 1     0.0541     0 -0.441 -0.591
#> # ℹ 997 more rows
...
#> $estimate
#>         E0         Em        E50 
#> -0.5922852  6.2036225  3.2986737 
#> 
#> $gradient
#> [1] -1.249014e-07 -7.485569e-07 -1.533461e-06
#> 
#> $hessian
#>               E0           Em          E50
...
#> 
#> $scaleC
#> [1] 0.002904243 0.036149671 0.033056773
#> 
#> $estimate.scaled
#>         E0         Em        E50 
#> -377.09979  156.77799   40.28616 
#> 
#> $covMethod
#> [1] "r (nlm)"
#> 
