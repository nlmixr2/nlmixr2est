...
#> lPop -700.5228 1143.354 1158.077      -568.6771        40110.07        706.2705
#> 
#> ── Time (sec $time): ──
#> 
#>              setup    optimize preprocess postprocess table compress    other
#> elapsed 0.03083911 0.000614479      0.044       0.015 0.027    0.001 1.483546
#> 
...
#> $hessian
#>                E0            Em          E50
#> E0   0.0016837810  0.0008000478 -0.003177108
#> Em   0.0008000478  0.0009921098 -0.003694294
#> E50 -0.0031771079 -0.0036942936  0.013883997
#> 
#> $cov.scaled
#>            E0        Em        E50
#> E0   5468.019  27171.09   8481.021
#> Em  27171.092 573535.14 158825.492
#> E50  8481.021 158825.49  44489.574
#> 
#> $r
#>                E0            Em          E50
