...
#> lPop -686.1126 1157.764 1172.488      -575.8822        13586.13        444.8445
#> 
#> ── Time (sec $time): ──
#> 
#>             setup  optimize covariance preprocess postprocess table compress
#> elapsed 0.2197383 0.9208039  5.749e-06      0.024       0.003 0.015    0.001
#>              other
#> elapsed 0.06445199
#> 
...
#> E0  -0.7174 0.2252 31.39 -0.7174 (-1.159, -0.2760)
#> Em    10.96  15.41 140.5     10.96 (-19.23, 41.16)
#> E50   5.065  4.781 94.38     5.065 (-4.305, 14.44)
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0343     0 -0.398 -0.717
#> 2 1     0.0489     1 -1.11  -0.716
#> 3 1     0.0501     0 -0.398 -0.716
#> # ℹ 997 more rows
...
#> $par
#>         E0         Em        E50 
#> -0.7173516 10.9632473  5.0650861 
#> 
#> $grad
#> [1]  1.906166e-07 -1.300118e-08 -1.253361e-06
#> 
#> $value
#> [1] 575.8822
#> 
...
#> $par.scaled
#>        E0        Em       E50 
#> -469.9770  332.6033  107.6464 
#> 
#> $hessian
#>                E0            Em          E50
#> E0   0.0013513361  0.0008546165 -0.002924798
#> Em   0.0008546165  0.0014173389 -0.004414305
#> E50 -0.0029247984 -0.0044143052  0.013975726
#> 
#> $cov.scaled
#>            E0        Em       E50
#> E0   7524.642  22581.30  8707.155
#> Em  22581.301 241242.75 80923.515
#> E50  8707.155  80923.51 27668.527
#> 
#> $r
#>                E0            Em          E50
#> E0   0.0006756680  0.0004273082 -0.001462399
#> Em   0.0004273082  0.0007086695 -0.002207153
#> E50 -0.0014623992 -0.0022071526  0.006987863
#> 
