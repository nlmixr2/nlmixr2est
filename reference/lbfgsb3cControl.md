...
#> lPop -735.8627 1108.014 1122.738      -551.0072        1796.255        133.7405
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.003536 0.033    0.001 1.713464
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>       Est.     SE  %RSE  Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.836 0.2342 28.02 -0.836 (-1.295, -0.3769)                    
#> Em   8.228  5.518 67.06    8.228 (-2.586, 19.04)                    
#> E50  3.874  2.047 52.85   3.874 (-0.1388, 7.887)                    
#> g        2  FIXED FIXED                        2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0467     0 -0.360 -0.835
#> 2 1     0.0602     0 -0.361 -0.834
#> 3 1     0.0626     0 -0.361 -0.834
#> # ℹ 997 more rows
...
#> $par
#>        E0        Em       E50 
#> -0.835989  8.228467  3.874026 
#> 
#> $grad
#> [1] -1.336005e-06 -1.543670e-06  8.954552e-06
#> 
#> $value
#> [1] 551.0072
#> 
...
#> 
#> $scaleC
#> [1] 0.002683344 0.033102757 0.029805497
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -498.88217  232.46898   63.87518 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001369903  0.001442528 -0.004393886
#> Em   0.001442528  0.003624000 -0.009556820
#> E50 -0.004393886 -0.009556820  0.026487096
#> 
#> $covMethod
#> [1] "r"
#> 
#> $cov.scaled
#>           E0        Em       E50
#> E0  7619.579  6190.683  3497.658
#> Em  6190.683 27782.876 11051.310
#> E50 3497.658 11051.310  4718.664
#> 
#> $cov
#>             E0         Em        E50
#> E0  0.05486351  0.5498941  0.2797371
#> Em  0.54989410 30.4442675 10.9037099
#> E50 0.27973709 10.9037099  4.1919080
#> 
#> $r
#>                E0            Em          E50
#> E0   0.0006849513  0.0007212638 -0.002196943
#> Em   0.0007212638  0.0018120002 -0.004778410
#> E50 -0.0021969431 -0.0047784101  0.013243548
#> 
