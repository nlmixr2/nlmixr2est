...
This option is for simply getting the maximum a-prior (MAP) also called
the posthoc estimates
...
- interaction:
  ...
  though you can set it to be \`TRUE\` as well.
