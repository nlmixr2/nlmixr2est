...
``` r
mufoceiControl(sigdig = 3, ..., muModel = c("lin", "irls", "none"))
```
...
- muModel:
  ...
  Selects the regression variant; for \`mufoceiControl()\` this is
  always \`"lin"\` and cannot be changed – use \`irlsfoceiControl()\`
