...
- [`.nlmixr0preProcessNpMuExpand()`](https://nlmixr2.github.io/nlmixr2est/reference/dot-nlmixr0preProcessNpMuExpand.md)
  : Preprocessing hook: mu-expand non-mu structural fixed-effect thetas
  for the nonparametric engines, before the rest of the pipeline builds
  on the ui. Doing it here (rather than mutating the ui mid-setup) keeps
  the injected pseudo-etas consistent through covariate/mu processing
  and model compilation. Off when control\$muExpand is FALSE.
...
- [`emviControl()`](https://nlmixr2.github.io/nlmixr2est/reference/emviControl.md)
  : Control for the variational inference methods emvi and fbvi in
  nlmixr2
