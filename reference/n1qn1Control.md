...
#> lPop -722.8599 1121.017 1135.74      -557.5086        274.8016        54.60866
#> 
#> ── Time (sec $time): ──
#> 
#>             setup  optimize covariance preprocess postprocess table compress
#> elapsed 0.2388597 0.3880024 2.2558e-05      0.034       0.006 0.028    0.001
#>              other
#> elapsed 0.07311541
#> 
...
#> E0  -0.7979 0.2538 31.81 -0.7979 (-1.295, -0.3005)                    
#> Em    5.430  1.949 35.88      5.430 (1.611, 9.250)                    
#> E50   2.461 0.9168 37.25     2.461 (0.6642, 4.258)                    
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0246     0 -0.372 -0.797
#> 2 1     0.0430     0 -0.372 -0.796
#> 3 1     0.0619     0 -0.373 -0.794
#> # ℹ 997 more rows
...
#> $par
#>        E0        Em       E50 
#> -0.797868  5.430384  2.460980 
#> 
#> $H
#>              [,1]         [,2]         [,3]
#> [1,]  0.001685478  0.003685567 -0.009856005
#> [2,]  0.003685567  0.016747283 -0.036458209
#> [3,] -0.009856005 -0.036458209  0.089842621
#> 
#> $c.hess
#>  [1]  0.001685478  0.003685567 -0.009856005  0.016747283 -0.036458209
#>  [6]  0.089842621  0.000000000  0.000000000  0.000000000  0.000000000
...
#> 
#> $scaleC
#> [1] 0.002966773 0.040829641 0.036872460
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -438.46786  119.75501   13.50203 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001684142  0.003671535 -0.009825552
#> Em   0.003671535  0.016599926 -0.036138210
#> E50 -0.009825552 -0.036138210  0.088994879
#> 
#> $cov.scaled
#>           E0       Em       E50
#> E0  7316.510 1209.753 1299.0306
#> Em  1209.753 2277.669 1058.4584
#> E50 1299.031 1058.458  618.1758
#> 
#> $r
#>                E0           Em          E50
#> E0   0.0008420709  0.001835768 -0.004912776
#> Em   0.0018357675  0.008299963 -0.018069105
#> E50 -0.0049127759 -0.018069105  0.044497440
#> 
