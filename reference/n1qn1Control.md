...
#> lPop -715.2361 1128.641 1143.364      -561.3205        493.1806        71.78877
#> 
#> ── Time (sec $time): ──
#> 
#>             setup  optimize covariance preprocess postprocess table compress
#> elapsed 0.1605783 0.2191577  7.834e-06      0.052       0.006 0.021    0.001
#>              other
#> elapsed 0.08725615
#> 
...
#> E0  -0.754 0.123  16.4 -0.754 (-0.996, -0.512)
#> Em    6.00  1.35  22.5       6.00 (3.35, 8.65)
#> E50   2.93 0.628  21.4       2.93 (1.70, 4.16)
...
#> $par
#>        E0        Em       E50 
#> -0.753981  6.000382  2.931380 
#> 
#> $H
#>           [,1]      [,2]      [,3]
#> [1,] 689.87988  90.73884 -66.53994
#> [2,]  90.73884  26.98769 -16.17208
#> [3,] -66.53994 -16.17208  10.72666
#> 
#> $c.hess
#>  [1] 689.87988  90.73884 -66.53994  26.98769 -16.17208  10.72666   0.00000
...
#> $par.scaled
#>        E0        Em       E50 
#> -1.626990  1.750191  2.862761 
#> 
#> $hessian
#>            E0        Em       E50
#> E0  775.27388  98.30835 -72.36571
#> Em   98.30835  27.60238 -16.69579
#> E50 -72.36571 -16.69579  11.12343
#> 
#> $cov.scaled
#>              E0         Em        E50
#> E0  0.003806844 0.01543479 0.04793314
#> Em  0.015434791 0.45585911 0.78463883
#> E50 0.047933135 0.78463883 1.57944768
#> 
#> $r
#>            E0        Em       E50
#> E0  775.27388  98.30835 -72.36571
