...
#> lPop -665.3563 1178.521 1193.244      -586.2604        592.3434        74.30249
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.002879 0.044    0.001 2.751121
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.     SE  %RSE   Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.6149 0.2328 37.86 -0.6149 (-1.071, -0.1586)                    
#> Em    5.619  2.877 51.19   5.619 (-0.01857, 11.26)                    
#> E50   3.292  1.594 48.43      3.292 (0.167, 6.417)                    
#> g         2  FIXED FIXED                         2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0558     0 -0.433 -0.613
#> 2 1     0.0713     1 -1.05  -0.612
#> 3 1     0.0727     1 -1.05  -0.612
#> # ℹ 997 more rows
...
#> $par
#>         E0         Em        E50 
#> -0.6149365  5.6194585  3.2920276 
#> 
#> $H
#>              [,1]         [,2]         [,3]
#> [1,]  0.001608257  0.002059103 -0.004831651
#> [2,]  0.002059103  0.006351324 -0.012136751
#> [3,] -0.004831651 -0.012136751  0.025449531
#> 
#> $c.hess
#>  [1]  0.001608257  0.002059103 -0.004831651  0.006351324 -0.012136751
#>  [6]  0.025449531  0.000000000  0.000000000  0.000000000  0.000000000
...
#> 
#> $scaleC
#> [1] 0.00281410 0.03160138 0.03001706
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -397.19641  161.00111   44.04311 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.001615050  0.002063644 -0.004854525
#> Em   0.002063644  0.006363145 -0.012160733
#> E50 -0.004854525 -0.012160733  0.025535156
#> 
#> $covMethod
#> [1] "r"
#> 
#> $cov.scaled
#>           E0       Em      E50
#> E0  6845.028 2971.915 2716.648
#> Em  2971.915 8286.025 4511.089
#> E50 2716.648 4511.089 2821.451
#> 
#> $cov
#>             E0        Em      E50
#> E0  0.05420688 0.2642908 0.229478
#> Em  0.26429082 8.2748158 4.279131
#> E50 0.22947800 4.2791312 2.542194
#> 
#> $r
#>                E0           Em          E50
#> E0   0.0008075248  0.001031822 -0.002427262
#> Em   0.0010318220  0.003181572 -0.006080366
#> E50 -0.0024272625 -0.006080366  0.012767578
#> 
