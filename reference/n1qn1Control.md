...
#> lPop -731.0988 1112.778 1127.501      -553.3891        606.9668        86.51049
#> 
#> ── Time (sec $time): ──
#> 
#>            setup table compress    other
#> elapsed 0.002934 0.032    0.001 0.853066
#> 
#> ── ($parFixed or $parFixedDf): ──
#> 
#>        Est.     SE  %RSE    Back-transformed(95%CI) BSV(SD) Shrink(SD)%
#> E0  -0.5419 0.2448 45.17 -0.5419 (-1.022, -0.06218)                    
#> Em    5.826  3.026 51.94      5.826 (-0.105, 11.76)                    
#> E50   2.934  1.458  49.7     2.934 (0.07624, 5.791)                    
#> g         2  FIXED FIXED                          2                    
#>  
...
#>   ID      TIME    DV  IPRED      v
#>   <fct>  <dbl> <dbl>  <dbl>  <dbl>
#> 1 1     0.0525     0 -0.459 -0.540
#> 2 1     0.0535     0 -0.459 -0.540
#> 3 1     0.0630     0 -0.459 -0.539
#> # ℹ 997 more rows
...
#> $par
#>         E0         Em        E50 
#> -0.5419083  5.8263398  2.9337483 
#> 
#> $H
#>              [,1]         [,2]        [,3]
#> [1,]  0.002022475  0.003394967 -0.00863400
#> [2,]  0.003394967  0.013555674 -0.02830389
#> [3,] -0.008634000 -0.028303887  0.06423434
#> 
#> $c.hess
#>  [1]  0.002022475  0.003394967 -0.008634000  0.013555674 -0.028303887
#>  [6]  0.064234340  0.000000000  0.000000000  0.000000000  0.000000000
...
#> 
#> $scaleC
#> [1] 0.003262478 0.045081885 0.040573536
#> 
#> $par.scaled
#>         E0         Em        E50 
#> -320.36102  117.14812   24.01373 
#> 
#> $hessian
#>               E0           Em          E50
#> E0   0.002033919  0.003398374 -0.008654062
#> Em   0.003398374  0.013507073 -0.028230876
#> E50 -0.008654062 -0.028230876  0.064143765
#> 
#> $covMethod
#> [1] "r"
#> 
#> $cov.scaled
#>           E0       Em      E50
#> E0  5628.517 2134.831 1698.960
#> Em  2134.831 4506.116 2271.250
#> E50 1698.960 2271.250 1291.198
#> 
#> $cov
#>             E0        Em       E50
#> E0  0.05990859 0.3139881 0.2248918
#> Em  0.31398809 9.1581230 4.1544156
#> E50 0.22489177 4.1544156 2.1255852
#> 
#> $r
#>               E0           Em          E50
#> E0   0.001016960  0.001699187 -0.004327031
#> Em   0.001699187  0.006753537 -0.014115438
#> E50 -0.004327031 -0.014115438  0.032071883
#> 
