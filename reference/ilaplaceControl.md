...
``` r
ilaplaceControl(sigdig = 4, ..., nAGQ = 1, muModel = c("irls", "lin", "none"))
```
...
- muModel:
  ...
  Selects the regression variant; for \`ilaplaceControl()\` this is
  always \`"irls"\` and cannot be changed – use \`mlaplaceControl()\`
