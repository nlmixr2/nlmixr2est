...
foceiSetup_ <- function(obj, data, theta, thetaMixIndex, thetaFixed = NULL, skipCov = NULL, rxInv = NULL, lower = NULL, upper = NULL, etaMat = NULL, control = NULL) {
    .Call(`_nlmixr2est_foceiSetup_`, obj, data, theta, thetaMixIndex, thetaFixed, skipCov, rxInv, lower, upper, etaMat, control)
}
