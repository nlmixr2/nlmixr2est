...
#'  straight to \code{linFim} with a message.  This includes a residual error with
...
saemControl <- function(seed = 99,
                        ...
                        etaDistMstep = FALSE,
                        etaDistParam = c("auto", "cdf", "direct"),
                        etaDistStart = NULL,
                        etaDistEvery = 20L,
                        ...
                        nonMuThetaGrad = FALSE,
                        nonMuThetaGradEvery = 1L,
                        nonMuThetaOpt = c("newuoa", "optimize", "nelderMead", "n1qn1"),
                        nonMuThetaSweeps = 2L,
